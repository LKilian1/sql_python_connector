...
tabelle2_columns = ['timestamp', 'mess_id_z', 'stab_id', 'messgeraet_id', 'messreihe_id'] + columns_needed_tabelle2 + ['deleted']
...
tabelle3_columns = ['timestamp', 'mess_id_i_u', 'stab_id', 'messgeraet_id', 'messreihe_id'] + columns_needed_tabelle3 + ['deleted']
