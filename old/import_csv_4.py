...
def main():
    ...
    for path in pathlib.Path(dir).rglob('*.csv'):
        # if 'stab' in str(path).lower():
        file_name = str(path)
        print(file_name)
            # if 'messreihe' in file_name:
            #     importer.import_csv_to_table(file_name, "messreihe")
            # elif 'init' in file_name:
            #     if '_t' in file_name:
            #         importer.import_csv_to_table(file_name, "messung_t")
            #     elif '_z' in file_name:
            #         importer.import_csv_to_table(file_name, "messung_z")
            #     elif '_i_u' in file_name:
            #         importer.import_csv_to_table(file_name, "messung_i_u")
            # else:
            #     if '_t' in file_name:
            #         importer.import_csv_to_table(file_name, "messung_t")
            #     elif '_z' in file_name:
